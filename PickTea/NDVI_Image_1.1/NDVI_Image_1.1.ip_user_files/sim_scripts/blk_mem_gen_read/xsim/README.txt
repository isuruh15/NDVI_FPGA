...
#
# Generated by export_simulation on Wed Aug 21 20:53:04 +0530 2019
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_read.sh' script.

./blk_mem_gen_read.sh -reset_run
...
./blk_mem_gen_read.sh -noclean_files

For more information on the script, please type './blk_mem_gen_read.sh -help'.
