...
architecture Behavioral of RS232_Manager is
...
begin
	...
	Inst_uart: UART_engine 
		GENERIC MAP (
			...
			CLOCK_FREQUENCY	=> RS232_CLOCK_FREQUENCY
		)
		PORT MAP(
			clock => clk_uart,
			reset => reset,
		...
		begin
			if (reset = '1') then
				...
				case state_TX is
					...
					when x"02" =>
						-- data_stream_in_done = '1' significa fin trasmisisone RS232
