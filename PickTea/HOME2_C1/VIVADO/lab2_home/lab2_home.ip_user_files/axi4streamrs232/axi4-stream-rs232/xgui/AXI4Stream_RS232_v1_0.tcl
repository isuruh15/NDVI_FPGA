...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "RS232_BAUD_RATE" -parent ${Settings} -widget comboBox
...
proc update_PARAM_VALUE.RS232_BAUD_RATE { PARAM_VALUE.RS232_BAUD_RATE } {
	# Procedure called to update RS232_BAUD_RATE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.RS232_BAUD_RATE { PARAM_VALUE.RS232_BAUD_RATE } {
	# Procedure called to validate RS232_BAUD_RATE
	return true
}

proc update_PARAM_VALUE.RS232_CLOCK_FREQUENCY { PARAM_VALUE.RS232_CLOCK_FREQUENCY } {
	# Procedure called to update RS232_CLOCK_FREQUENCY when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.RS232_CLOCK_FREQUENCY { PARAM_VALUE.RS232_CLOCK_FREQUENCY } {
	# Procedure called to validate RS232_CLOCK_FREQUENCY
	return true
}
...
proc update_MODELPARAM_VALUE.RS232_BAUD_RATE { MODELPARAM_VALUE.RS232_BAUD_RATE PARAM_VALUE.RS232_BAUD_RATE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.RS232_BAUD_RATE}] ${MODELPARAM_VALUE.RS232_BAUD_RATE}
}

proc update_MODELPARAM_VALUE.RS232_CLOCK_FREQUENCY { MODELPARAM_VALUE.RS232_CLOCK_FREQUENCY PARAM_VALUE.RS232_CLOCK_FREQUENCY } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.RS232_CLOCK_FREQUENCY}] ${MODELPARAM_VALUE.RS232_CLOCK_FREQUENCY}
}
